...
function brikpanel_settings_fields() {
    ...
    $fields = [
        ...
        [
            ...
            'type'              => 'number',
            'desc'              => __('seconds', 'brikpanel'),
            'desc_tip'          => __('How often an open store page reports that its visitor is still there, for the Live view. Higher values mean fewer requests to your server; the Live view reacts a little slower. Default is 30 seconds.', 'brikpanel'),
            'default'           => '30',
            'custom_attributes' => [
                'min'  => '10',
                'max'  => '300',
