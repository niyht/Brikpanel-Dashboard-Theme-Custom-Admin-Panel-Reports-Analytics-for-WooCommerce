			...
			lists.forEach(function (ul) {
				...
				ul.querySelectorAll(':scope > .brikpanel-navc-item').forEach(function (li) {
					...
					if (type === 'system') {
						...
						const submenuItems = li.querySelectorAll(':scope .brikpanel-navc-submenu-item');
		...
		function createCustomRow(data) {
			...
			li.innerHTML =
				'<div class="brikpanel-navc-row">' +
					...
					'</label>' +
					'<button type="button" class="brikpanel-navc-iconbtn" data-navc-action="edit" aria-label="Edit">' +
					...
					'</button>' +
					'<button type="button" class="brikpanel-navc-iconbtn brikpanel-navc-iconbtn-danger" data-navc-action="delete" aria-label="Delete">' +
